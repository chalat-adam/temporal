...
//
// CURRENT: flagged. DESIRED: silent. Mitigations today: declare the field
// //ownership:frozen (see testdata/src/frozen — also enforces no writes),
// //ownership:result owned on an accessor, or //ownership:ignore at the embed. The
// remaining gap is auto-proving an un-annotated field is never mutated.
